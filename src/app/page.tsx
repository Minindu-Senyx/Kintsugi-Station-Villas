...
function Eyebrow({ children, tone }: { children: React.ReactNode; tone: "taupe" | "gold" }) {
  return (
    ...
    >
      {children}
      <span aria-hidden="true" className="h-px w-[2.5rem] bg-[#c3a876]" />
    </p>
  );
}
      ...
      <main>
        ...
        <section className="relative h-auto min-h-[36rem] lg:h-[27.3125rem] lg:min-h-0">
          ...
          <div className="frame relative flex h-full flex-col px-5 pb-6 pt-24 lg:block lg:px-[3.625rem] lg:pb-0 lg:pt-[6.55rem]">
            <h1 className="font-serif text-[2.5rem] leading-[1.08] text-white lg:text-[2.98rem] lg:leading-[3.02rem]">
              A Secluded Hill
              <br />
              Country Sanctuary
            </h1>
            <p className="mt-[1.05rem] max-w-[19.2rem] text-[0.91rem] leading-[1.25rem] text-white/95">
              An exclusive private estate in the mist-veiled hills of Kandy, Sri Lanka.
            </p>
            <span aria-hidden="true" className="mt-[1.85rem] block h-px w-[3.2rem] bg-[#b89a5f]" />
            <div className="mt-auto pt-10 lg:absolute lg:left-1/2 lg:top-[21.7rem] lg:mt-0 lg:w-[43.5rem] lg:-translate-x-1/2 lg:pt-0">
              <BookingBar />
            </div>
          </div>
        </section>
          ...
          <div className="frame px-5 lg:px-[3.625rem]">
            <div className="flex flex-col gap-10 py-12 lg:flex-row lg:gap-0 lg:pb-[1.3rem] lg:pt-[1.8rem]">
              <div className="lg:w-[22rem] lg:pt-[0.6rem]">
                ...
                <h2 className="mt-[1.3rem] font-serif text-[2.7rem] leading-[2.75rem] text-ink">
                  One Villa.
                  <br />
                  Complete Solitude.
                </h2>
                <p className="mt-[0.85rem] text-[0.875rem] leading-[1.26rem] tracking-[0.004em] text-ink-soft">
              ...
              <div className="grid grid-cols-2 gap-3 lg:ml-auto lg:w-[31.5rem] lg:gap-[0.75rem]">
                {estateImages.map((img) => (
                  <figure key={img.src}>
                    <div className="relative aspect-[246/259] overflow-hidden">
                      <Image src={img.src} alt={img.alt} fill sizes="(min-width: 900px) 25vw, 50vw" className="object-cover" />
                    </div>
                    <figcaption className="mt-[0.7rem] text-[0.6rem] font-medium tracking-[0.08em] text-[#2b2c2a] uppercase">
                      {img.caption}
                    </figcaption>
                  </figure>
                ))}
            ...
            <div className="border-t border-[#e6e0d7] pb-12 pt-[1.6rem] lg:pb-[1.85rem] lg:pt-[1.2rem]">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <Link
                  href="/gallery"
                  className="flex items-center gap-[0.35rem] text-[0.7rem] text-[#2b2c2a] transition-colors hover:text-gold"
                >
                  View Full Gallery (24 Photos)
                  <ArrowRight className="size-[0.8rem]" strokeWidth={1.6} aria-hidden="true" />
                </Link>
              </div>
              <div className="mt-[1.2rem] grid grid-cols-2 gap-[0.625rem] lg:grid-cols-[226fr_224fr_223fr_203fr]">
                {glimpses.map((img) => (
                  <figure key={img.src}>
                    <div className="relative h-40 overflow-hidden lg:h-[10.1875rem]">
                      <Image src={img.src} alt={img.alt} fill sizes="(min-width: 900px) 23vw, 50vw" className="object-cover" />
                    </div>
                    <figcaption className="mt-[0.7rem] text-[0.6rem] font-medium tracking-[0.08em] text-[#2b2c2a] uppercase">
                      {img.caption}
                    </figcaption>
        ...
        <section className="relative overflow-hidden bg-linen">
          <KintsugiVeins
            variant="top-right"
            className="pointer-events-none absolute right-0 top-0 h-[15.3rem] w-[6.9rem] lg:right-[max(0rem,calc(50vw-32rem))]"
          />
          <KintsugiVeins
            variant="bottom-left"
          ...
          <div className="frame relative flex flex-col gap-10 px-5 py-12 lg:h-[14.8rem] lg:flex-row lg:gap-0 lg:px-[3.625rem] lg:py-0">
            <div className="lg:w-[22.3rem] lg:pt-[2.35rem]">
              ...
              <h2 className="mt-[1.2rem] font-serif text-[2.33rem] leading-[2.28rem] text-ink">
                Your Private Escape
                <br />
                Awaits
              </h2>
            ...
            <ul className="space-y-[1.02rem] lg:w-[20.25rem] lg:pt-[1.95rem]">
              {features.map(({ icon: Icon, title, text }) => (
                <li key={title} className="flex items-start gap-[1.2rem]">
            ...
            <div className="border-[#d9cfbf] lg:mb-[1.75rem] lg:ml-[0.1rem] lg:mt-[1.8rem] lg:border-l lg:pl-[1.8rem]">
              ...
              <Link
                href={bookHref}
                className="mt-[1.4rem] flex h-[2.25rem] w-full items-center justify-center bg-gold text-[0.78rem] text-[#f7f1e4] transition-colors hover:bg-[#8f6d31] lg:w-[10.7rem]"
              >
                Book Your Stay
              </Link>
